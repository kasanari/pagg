...
def main(seed=888):
    ...
    configs = [
        dict(name="small", size=50, lateral_connections=5, num_flags=5, add_defense=True, mu=0),
        dict(name="small_no_defense", size=50, lateral_connections=5, num_flags=5, add_defense=False, mu=0),
